...
<div style="padding: 20px;">
    ...
    <form action="/AUTSE2015NSA/MethodFormServlet" method="POST">
        ...
        <p>
            Description <br/>
            <textarea name="methodDescription" ><jsp:getProperty name="method" property="description"/></textarea>
        </p>
        <h3>Methodology</h3>
        <p>
            Name <br/>
        ...
        <p>
            Description <br/>
            <textarea name="methodologyDescription" ><jsp:getProperty name="methodology" property="description"/></textarea>
        </p>
